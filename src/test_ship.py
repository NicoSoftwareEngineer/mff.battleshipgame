...
def test_ship_creation():
    """Ships remember their initial size, coordinates and sunk state."""
...
def test_ship_try_hit_and_sinking():
    """`try_hit` reports HIT before returning SINKED after the final segment."""
...
def test_ship_check_if_contains_coordinates():
    """Ship detects coordinates it occupies and rejects others."""
...
def test_ship_creation_on_invalid_coordinates():
    """Validation rejects out-of-range coordinates but accepts valid sequences."""
